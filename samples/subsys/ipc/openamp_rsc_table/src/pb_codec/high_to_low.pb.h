...
#define _SLACState_MIN SLACState_UDF
#define _SLACState_MAX SLACState_NOK
#define _SLACState_ARRAYSIZE ((SLACState)(SLACState_NOK+1))


/* Initializer values for message structs */
#define Empty_init_default                       {0}
#define SetPWM_init_default                      {_PWMState_MIN, 0}
#define SetSLAC_init_default                     {_SLACState_MIN}
...
#define SetSLAC_init_zero                        {_SLACState_MIN}
...
#define SetSLAC_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    state,             1)
#define SetSLAC_CALLBACK NULL
#define SetSLAC_DEFAULT NULL
...
X(a, STATIC,   ONEOF,    MESSAGE,  (message,set_slac,message.set_slac),   6)
...
#define HighToLow_message_set_slac_MSGTYPE SetSLAC

extern const pb_msgdesc_t Empty_msg;
extern const pb_msgdesc_t SetPWM_msg;
extern const pb_msgdesc_t SetSLAC_msg;
...
#define SetSLAC_fields &SetSLAC_msg
